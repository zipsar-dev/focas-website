const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center w-[90%] md:w-[80%] mx-auto overflow-hidden pt-24 sm:pt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 z-10 relative text-left order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <button className="bg-white/70 backdrop-blur-sm border border-black border-b-[5px] rounded-full px-6 py-3 text-blue-700 font-semibold hover:bg-white/90 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto">
                Start Learning
              </button>
              <button className="bg-white/70 backdrop-blur-sm border border-black rounded-full px-6 py-3 text-blue-700 font-semibold hover:bg-white/90 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto">
          ...
          <div className="relative flex-center min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] order-1 lg:order-2">
            ...
            <div className="absolute inset-0 pointer-events-none z-20 text-left">
              ...
              {/* Bottom Right Card */}
              <div className="floating-card-4 absolute bottom-[5%] right-2 sm:right-8 bg-white p-2 sm:p-3 rounded-lg sm:rounded-xl shadow-2xl border border-gray-100 flex items-center gap-1 sm:gap-2 w-24 sm:w-44 transform hover:scale-110 transition-transform duration-300">
